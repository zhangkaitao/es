 ...
 */
package com.sishuok.es.sys.resources.entity;
...
public class Menu extends BaseEntity<Long> implements Treeable<Long> {
     ...
     * 是否有叶子节点
     */
    @Formula(value = "(select count(*) from menu f_t where f_t.parent_id = id)")
    ...
    public String getBranchDefaultIcon() {
        return "static/comp/treetable/images/folder.png";
    }
    ...
    public String getLeafDefaultIcon() {
        return "static/comp/treetable/images/file.png";
    }
}
