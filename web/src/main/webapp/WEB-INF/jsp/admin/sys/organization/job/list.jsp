...
<div data-table="table" class="panel">
    ...
    <ul class="nav nav-tabs">
        <li <c:if test="${empty param['search.show_eq']}">class="active"</c:if>>
            <a href="${ctx}/admin/sys/organization/job/list/${id}">
                <i class="icon-table"></i>
                所有
            </a>
        </li>
        <li <c:if test="${param['search.show_eq'] eq 'true'}">class="active"</c:if>>
            <a href="${ctx}/admin/sys/organization/job/list/${id}?search.show_eq=true">
                <i class="icon-table"></i>
                显示的
            </a>
        </li>
        <li <c:if test="${param['search.show_eq'] eq 'false'}">class="active"</c:if>>
            <a href="${ctx}/admin/sys/organization/job/list/${id}?search.show_eq=false">
                <i class="icon-table"></i>
                隐藏的
            </a>
        </li>
