...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var ztree = $.zTree.initMovableTree(
                zNodes,
                //重命名url模式
                "${ctx}/admin/sys/organization/organization/ajax/rename/{id}?newName={newName}",
                //删除url模式
                "${ctx}/admin/sys/organization/organization/ajax/delete/{id}",
                //新增url模式
                "${ctx}/admin/sys/organization/organization/ajax/appendChild/{id}",
                //移动url模式
                "${ctx}/admin/sys/organization/organization/ajax/move/{sourceId}/{targetId}/{moveType}",
                //异步模式
                async,
                //异步加载url
                "${ctx}/admin/sys/organization/organization/ajax/load"
        ...
        $.zTree.initAutocomplete(
                ...
                function(searchName) {
                    location.href = "${ctx}/admin/sys/organization/organization/tree?async=" + async + "&searchName=" + searchName;
                });
