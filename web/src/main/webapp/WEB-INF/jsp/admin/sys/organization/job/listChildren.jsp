...
<div data-table="table" class="panel">
    ...
    <ul class="nav nav-tabs">
        <li ${empty param['search.show_eq'] ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/organization/job/children/${parent.id}">
                <i class="icon-table"></i>
                [${parent.name}]子节点列表
            </a>
        </li>
        <li ${param['search.show_eq'] eq 'true' ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/organization/job/children/${parent.id}?search.show_eq=true">
                <i class="icon-table"></i>
                显示的
            </a>
        </li>
        <li ${param['search.show_eq'] eq 'false' ? 'class="active"' : ''}>
            <a href="${ctx}/admin/sys/organization/job/children/${parent.id}?search.show_eq=false">
                <i class="icon-table"></i>
                隐藏的
            </a>
        </li>
        <li>
            <a href="${ctx}/admin/sys/organization/job/update/${parent.id}">
