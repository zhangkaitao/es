...
<div>
  <div class="btn-group">
      ...
      <a id="create" class="btn" href="${ctx}/showcase/editor/create">
  ...
  <table class="sort-table table table-bordered table-hover table-striped">
      ...
      <c:forEach items="${page.content}" var="m">
        <tr>
            ...
            <td>${m.content}</td>
            <td>
                <a class="btn btn-link edit-btn" title="修改" href="${ctx}/showcase/editor/update/${m.id}">
                    <span class=" icon-edit"></span>
                </a>
                <a class="btn btn-link edit-btn" title="删除" href="${ctx}/showcase/editor/delete/${m.id}">
                    <span class=" icon-trash"></span>
                </a>
            </td>
        </tr>
