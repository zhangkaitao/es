...
--用户--组织机构--工作职务关系
insert into `sys_user_organization_job` (`id`, `user_id`, `organization_id`, `job_id`) values(1, 1, 2, 1);
insert into `sys_user_organization_job` (`id`, `user_id`, `organization_id`, `job_id`) values(2, 1, 3, 2);

insert into `sys_user_organization_job` (`id`, `user_id`, `organization_id`, `job_id`) values(3, 1, 3, 1);


--组织机构单独授权
insert into sys_auth (`id`, `organization_id`, `job_id`, `user_id`, `group_id`, `role_ids`, `type`)
    values(1, 2, 1, 0, 0, '1,3', 'organization_job');
insert into sys_auth (`id`, `organization_id`, `job_id`, `user_id`, `group_id`, `role_ids`, `type`)
    values(2, 3, 2, 0, 0, '2', 'organization_job');
insert into sys_auth (`id`, `organization_id`, `job_id`, `user_id`, `group_id`, `role_ids`, `type`)
    values(3, 2, 3, 0, 0, '2', 'organization_job');
