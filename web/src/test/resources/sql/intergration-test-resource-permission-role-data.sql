...
insert into `sys_permission` (`id`, `name`, `permission`, `description`, `show`) values (6,  '不显示的权限', 'none', '不显示的权限', 0);

--角色
insert into `sys_role` (`id`, `name`, `role`, `description`, `show`) values (1,  '管理员', 'admin', '拥有所有权限', 1);
insert into `sys_role` (`id`, `name`, `role`, `description`, `show`) values (2,  '测试人员', 'test', '测试人员', 1);
insert into `sys_role` (`id`, `name`, `role`, `description`, `show`) values (3,  '不显示的角色', 'none', '测试人员', 0);
