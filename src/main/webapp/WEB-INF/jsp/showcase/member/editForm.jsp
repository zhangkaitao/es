...
<div class="panel">
    ...
    <ul class="nav nav-tabs">
        <shiro:hasPermission name="showcase:member:create">
        <c:if test="${op eq '新增'} ">
            <li ${op eq '新增' ? 'class=active' : ''}>
                <a href="${ctx}/showcase/member/create?BackURL=<es:BackURL/>">
        ...
        <c:if test="${not empty m.id}">
            <li ${op eq '查看' ? 'class=active' : ''}>
                <a href="${ctx}/showcase/member/${m.id}?BackURL=<es:BackURL/>">
                    <i class="icon-eye-open"></i>
                    查看
                </a>
            </li>
            <shiro:hasPermission name="showcase:member:update">
            <li ${op eq '修改' ? 'class=active' : ''}>
                <a href="${ctx}/showcase/member/${m.id}/update?BackURL=<es:BackURL/>">
                    <i class="icon-edit"></i>
                    修改
                </a>
            </li>
            </shiro:hasPermission>
            <shiro:hasPermission name="showcase:member:delete">
            <li ${op eq '删除' ? 'class=active' : ''}>
                <a href="${ctx}/showcase/member/${m.id}/delete?BackURL=<es:BackURL/>">
