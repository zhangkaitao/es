...
<ul class="nav nav-tabs">
    <li ${empty param['search.show_eq'] ? 'class="active"' : ''}>
        <a href="${ctx}/admin/shop/navigation/tree?async=${not empty param.async and param.async eq true}">
    ...
    <li ${not empty param['search.show_eq'] ? 'class="active"' : ''}>
        <a href="${ctx}/admin/shop/navigation/tree?async=${not empty param.async and param.async eq true}&search.show_eq=true">
            <i class="icon-table"></i>
            显示的
        </a>
    </li>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $.zTree.initMovableTree({
            zNodes : zNodes,
            urlPrefix : "${ctx}/admin/shop/navigation/tree",
            async : async,
