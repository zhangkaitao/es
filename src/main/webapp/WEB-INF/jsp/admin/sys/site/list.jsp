      ...
      <div class="modal-dialog">
	    ...
	    <div class="btn-group">
	      ...
	      <ul class="dropdown-menu model_fields pull-right" role="menu" aria-labelledby="dLabel">
	        ...
	        <li>
	        	<a href="?_p_is_superuser__exact=1&amp;_cols=id.username.email.first_name.last_name.is_staff&amp;_p_is_active__exact=1">
	          		<i class="icon-blank"></i>
	          		ID</a>
	        </li>
	        <li>
	        	<a href="?_p_is_superuser__exact=1&amp;_cols=username.email.first_name.last_name.is_staff.password&amp;_p_is_active__exact=1">
	          		<i class="icon-blank"></i>
	          		名称</a>
	         </li>
	      </ul>
